...
class DeviceForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'hostname': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'FQDN/Hostname'}
            ),
            'model_name': forms.TextInput(
                attrs={
                    'class': 'form-control',
                    'placeholder': 'e.g. Cisco C240 M5',
                }
            ),
            ...
            'size': forms.NumberInput(
                attrs={'class': 'form-control', 'min': 1, 'max': 42}
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['rack'].queryset = Rack.objects.select_related(
            'row__data_center'
        ).order_by('row__data_center__name', 'row__name', 'name')
...
class TicketForm(forms.ModelForm):
        ...
        widgets = {
            ...
            'description': forms.Textarea(
                attrs={
                    'class': 'form-control',
                    'rows': 4,
                    'placeholder': 'Detailed technical logs...',
                }
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['device'].queryset = Device.objects.all().order_by(
            'hostname'
        )
...
class VLANForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'vid': forms.NumberInput(
                attrs={'class': 'form-control', 'min': 1, 'max': 4094}
            ),
            'name': forms.TextInput(attrs={'class': 'form-control'}),
...
class VRFForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'name': forms.TextInput(attrs={'class': 'form-control'}),
            'rd': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'e.g. 65000:1'}
            ),
            'description': forms.Textarea(
