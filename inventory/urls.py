...
urlpatterns = [
    ...
    path(
        'devices/add/', views.DeviceCreateView.as_view(), name='device_create'
    ),
    path(
        'devices/<int:pk>/delete/',
        views.DeviceDeleteView.as_view(),
        name='device_confirm_delete',
    ),
    path(
        'devices/<int:pk>/edit/',
    ...
    path(
        'ips/<int:pk>/edit/',
        views.IPAddressUpdateView.as_view(),
        name='ip_update',
    ),
    path(
        'ips/<int:pk>/delete/',
    ...
    path(
        'ips/available/<int:prefix_id>/',
        views.GetAvailableIPsView.as_view(),
    ...
    path(
        'vrfs/<int:pk>/edit/', views.VRFUpdateView.as_view(), name='vrf_update'
    ),
    path(
        'vrfs/<int:pk>/delete/',
        views.VRFDeleteView.as_view(),
        name='vrf_delete',
    ),
    path('prefixes/', views.PrefixListView.as_view(), name='prefix_list'),
    path(
        'prefixes/add/', views.PrefixCreateView.as_view(), name='prefix_create'
    ),
    path(
        'prefixes/<int:pk>/edit/',
        views.PrefixUpdateView.as_view(),
        name='prefix_update',
    ),
    path(
    ...
    path(
        'datacenters/',
        views.DataCenterListView.as_view(),
        name='datacenter_list',
    ),
    path(
        'datacenters/add/',
        views.DataCenterCreateView.as_view(),
        name='datacenter_create',
    ),
    path(
        'datacenters/<int:pk>/edit/',
        views.DataCenterUpdateView.as_view(),
        name='datacenter_update',
    ),
    path(
        'datacenters/<int:pk>/delete/',
        views.DataCenterDeleteView.as_view(),
        name='datacenter_delete',
    ),
    ...
    path(
        ...
        name='rack_confirm_delete',
    ),
    # Row Management
    path('rows/', views.RowListView.as_view(), name='row_list'),
    path('rows/add/', views.RowCreateView.as_view(), name='row_create'),
    path(
        'rows/<int:pk>/edit/', views.RowUpdateView.as_view(), name='row_update'
    ),
    path(
        'rows/<int:pk>/delete/',
        views.RowDeleteView.as_view(),
        name='row_confirm_delete',
    ),
    # Ticket Routes
    path(
        'tickets/add/', views.TicketCreateView.as_view(), name='ticket_create'
    ),
    path(
